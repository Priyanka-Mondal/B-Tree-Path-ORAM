...
Clean(objects["orionsq"]+objects["oriel"]+objects["morion"]+objects["mitra"]+objects["orion"]+objects["borion"]+objects["foram"]+objects["orion2"], 'build')
...
env.Default(['orionsq','oriel','orion','mitra','morion','borion','foram','orion2'])
